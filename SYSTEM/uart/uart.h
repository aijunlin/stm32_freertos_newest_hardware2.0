...
extern volatile int8_t   u1_flag;

extern volatile uint8_t  u2_recvbuf[RX2_BUF_SIZE];
extern volatile uint8_t  u2_count;
extern volatile int8_t   u2_flag;


extern volatile uint8_t  u3_recvbuf[RX3_BUF_SIZE];
extern volatile uint16_t u3_count;
extern volatile uint16_t u3_len;
extern volatile int8_t   u3_flag;



// 五、函数声明
extern void UART1_Init( uint32_t baud_rate);
extern void USART1_SendStr(const char *str);
extern void USART1_IRQHandler(void);

extern void UART2_Init( uint32_t baud_rate);
extern void USART2_SendStr(const char *str);
extern void USART2_IRQHandler(void);

extern void UART3_Init( uint32_t baud_rate);
extern void USART3_SendStr(const char *str);
extern void USART3_IRQHandler(void);

extern void USART_BlueTooth_GetMsg(void);	
extern void USART_BlueTooth_SetMsg(const char* name, const char* pswd, const char* uart);
