...
#define MFRC522_CS  PGout(7)
#define MFRC522_Rst PGout(8)
...
#define MAX_LEN										18
//MFRC522 test
extern void SPI3_MFRC522_Test(void);
extern void SPI3_MFRC522_Init(void); 
extern void SPI_Send(SPI_TypeDef* SPIx, u8 val);
