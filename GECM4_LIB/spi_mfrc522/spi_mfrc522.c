...
void SPI3_MFRC522_Test(void)
{
	...
	else
	{
		spi_mfrc522_count++;
		delay_ms(1);
		if(spi_mfrc522_count == 250)
		{
			printf("You can place the card on the RFID again now!\r\n");
			spi_mfrc522_flag  = 1;	
			spi_mfrc522_count = 0;
		}	
	}
