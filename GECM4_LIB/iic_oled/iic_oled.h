...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOD,GPIO_Pin_10)//SDA IIC接口的时钟信号
#define OLED_SCLK_Set() GPIO_SetBits(GPIOD,GPIO_Pin_10)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_15)//SCL IIC接口的数据信号
...
extern uint8_t IIC_OLED_RecvByte(void);
extern void    IIC_OLED_SendAck(uint8_t ack);	
