...
// 二、宏定义(函数、变量、常量)
#define LED1(X) (X)?(PFout(9)=0) :(PFout(9) =1)
...
extern void LED_WaterRunning(uint16_t speed, uint8_t direction);
extern void LED_HorseRunning(uint16_t speed, uint8_t direction);
